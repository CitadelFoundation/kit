 ...
 * Do not edit by hand.
 */
export const BUILT_IN_TEMPLATE_CATALOG = [
    {
        manifest: {
            id: "blank",
            label: "Blank",
            summary: "A minimal publishing site with a clean homepage and room to grow.",
            audience: "Developers who want the local studio and content model without preloaded docs or editorial content.",
            screenshot: "screenshots/preview.svg",
            supportedDeployPresets: ["none", "cloudflare-pages"],
            kitPublishingVersion: "0.1.2",
        },
        createCommand: "bunx @citadelfoundation/kit-publishing create my-site --template blank",
        runCommand: "cd my-site && bun install && bun run studio:dev",
        deployCtas: [
            {
                preset: "cloudflare-pages",
                label: "Deploy to Cloudflare Pages",
                createCommand: "bunx @citadelfoundation/kit-publishing create my-site --template blank --deploy cloudflare-pages",
            },
        ],
    ...
    },
    {
        manifest: {
            id: "starter",
            label: "Starter",
            summary: "A balanced publishing site with one docs section, one post, and the same local-first workflow.",
            audience: "Teams who want a ready-to-run site structure without heavy editorial styling.",
            screenshot: "screenshots/preview.svg",
            supportedDeployPresets: ["none", "cloudflare-pages"],
            kitPublishingVersion: "0.1.2",
        },
        createCommand: "bunx @citadelfoundation/kit-publishing create my-site --template starter",
        runCommand: "cd my-site && bun install && bun run studio:dev",
        deployCtas: [
            {
                preset: "cloudflare-pages",
                label: "Deploy to Cloudflare Pages",
                createCommand: "bunx @citadelfoundation/kit-publishing create my-site --template starter --deploy cloudflare-pages",
            },
        ],
    ...
    },
    {
        manifest: {
            id: "publication",
            label: "Publication",
            summary: "A more opinionated editorial template with a richer homepage, multiple docs pages, and a seeded blog.",
            audience: "Teams who want a polished publication shape with stronger editorial defaults from day one.",
            screenshot: "screenshots/preview.svg",
            supportedDeployPresets: ["none", "cloudflare-pages"],
            kitPublishingVersion: "0.1.2",
        },
        createCommand: "bunx @citadelfoundation/kit-publishing create my-site --template publication",
        runCommand: "cd my-site && bun install && bun run studio:dev",
        deployCtas: [
            {
                preset: "cloudflare-pages",
                label: "Deploy to Cloudflare Pages",
                createCommand: "bunx @citadelfoundation/kit-publishing create my-site --template publication --deploy cloudflare-pages",
            },
        ],
